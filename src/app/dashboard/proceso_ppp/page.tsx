...
function Page() {
  ...
  return (
    ...
    //
    // <section className="flex flex-col justify-center items-center w-full" style={{ overflow: 'hidden' }}>
    //         <p className="text-[64px] mt-[120px] font-bold">Antes de continuar</p>
    //         <p className="text-[24px]">Debes conocer estos pasos</p>
                  ...
                  <div className="flex flex-col items-start gap-2 self-stretch">
                    ...
                    <div className="flex flex-col items-start justify-between gap-1 self-stretch">
                      ...
                      <div className="w-full font-sans text-xs text-[#757575]">
                        • Para generar la carta de presentación necesitas tener
                        a disposición la informacion que se solicita.
                      </div>
                      <div className="font-sans text-xs text-[#757575]">
