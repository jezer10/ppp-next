...
function InfoStudent(modalProps: ModalProps) {
    return (
        <>
                ...
                <section className="flex flex-row gap-5">
                    <div className="flex flex-col gap-3">
                        <div className="flex flex-col">
                            ...
                            <span className="text-sm text-[#bababa]"> {modalProps.fullName} </span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-[#7e7e7e]"> Código</span>
                            <span className="text-sm text-[#bababa]"> {modalProps.codeStudent} </span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-[#7e7e7e]"> Escuela Profesional</span>
                            <span className="text-sm text-[#bababa]"> {modalProps.school} </span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-[#7e7e7e]"> Ciclo</span>
                            <span className="text-sm text-[#bababa]"> {modalProps.cycle} </span>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-[#7e7e7e]"> DNI</span>
                            <span className="text-sm text-[#bababa]"> {modalProps.DNI} </span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-[#7e7e7e]"> Celular</span>
                            <span className="text-sm text-[#bababa]"> {modalProps.phone} </span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-[#7e7e7e]"> Correo </span>
                            <span className="text-sm text-[#bababa]"> {modalProps.email} </span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-[#7e7e7e]"> Modalidad de PPP</span>
                            <span className="text-sm text-[#bababa]"> {modalProps.practicesMode} </span>
                        </div>
                    </div>
                </section>
            </section>
